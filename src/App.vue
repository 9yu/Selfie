  ...
  <div class="container" id="app">
  	<div class="row center-xs">
  		<div class="col-xs-1" id="left">
			<section id="section">
				<router-link to="/"><span>index</span></router-link>
				<router-link to="/article"><span>article</span></router-link>
				<router-link to="/link"><span>link</span></router-link>
...
export default {
  ...
  methods: {
    setLanguage (val) {
      ...
      window.localStorage.setItem('userLanguage', val)
    }
  }
}
</script>
...
#section a:nth-child(1) {
	background-image: url('./assets/pic/section1.png');
	background-size: 100%;
}
#section a:nth-child(2) {
	background-image: url('./assets/pic/section2.png');
	background-size: 100%;
}
#section a:nth-child(3) {
	background-image: url('./assets/pic/section3.png');
	background-size: 100%;
}
#section a:nth-child(4) {
	background-image: url('./assets/pic/section4.png');
	background-size: 100%;
}
#section span {
	display: none;
